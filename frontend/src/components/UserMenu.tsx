  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-700/60 transition"
      >
      ...
      {/* 下拉面板 */}
      {open && (
        <div className="absolute right-0 top-full mt-1.5 w-52 bg-gray-800 border border-gray-700 rounded-xl shadow-xl overflow-hidden z-50 animate-fade-in">
          {/* 用户信息区 */}
          ...
          <div className="py-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-700/50 transition"
            >
