...
| 登录页 | 题库首页 |
|:------:|:--------:|
| ![登录页](image/登录页.png) | ![题库首页](image/题库首页.png) |

### 做题 / 学习

| 做题练习页（Monaco 编辑器 + AI 助教） | 做题情况页 |
|:-------------------------------------:|:----------:|
| ![做题练习页](image/做题练习页.png) | ![做题情况页](image/做题情况页.png) |

### 比赛系统

| 比赛中心首页 | 比赛详细页 |
|:------------:|:----------:|
| ![比赛中心首页](image/比赛中心首页.png) | ![比赛详细页](image/比赛详细页.png) |

### 组题 / 团队 / 个人设置

| 组题中心页 | 队伍详细页 | 信息配置页 |
|:----------:|:----------:|:----------:|
| ![组题中心页](image/组题中心页.png) | ![队伍详细页](image/队伍详细页.png) | ![信息配置页](image/信息配置页.png) |
